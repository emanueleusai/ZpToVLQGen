...
process.source = cms.Source("LHESource",
    ...
    fileNames = cms.untracked.vstring('file:/nfs/dust/cms/user/usaiem/gen/cmsgrid_final.lhe')
)
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:/nfs/dust/cms/user/usaiem/gen/had.root'),
